...
const initialThemeSwitchHTML = '<button class="button is-small" onclick="switchTheme();">';
const initialButtonTextHTML = '&nbsp;&nbsp;<span class="mdi ';
  ...
  if (currentTheme) {
    ...
    try {
      ...
      toggleSwitch.innerHTML =
        `${initialThemeSwitchHTML}${otherThemeName} Theme${initialButtonTextHTML}${iconName}${finalButtonTextHTML}${finalThemeSwitchHTML}`;
    } catch (e) {
    }
    try {
      setupLogo();
