...
(function () {
    ...
    // Will slice an indentation amount on each line of the snippet (amount based on the line
    // having the lowest indentation length)
    function betterTrim(snippetEl) {
        ...
        return (function (snippetEl) {
            ...
            var pad = lines.reduce(function (acc, line) {
                if (line.length > 0 && trimLeft(line).length > 0 && acc > line.length - trimLeft(
                    line).length) {
...
!function (e) {
    ...
    function f(e, t, a, i) {
        ...
        function h() {
            ...
            for (a = "", t = 0, E.lR.lastIndex = 0, r = E.lR.exec(k); r;) {
                a +=
                    n(k.substring(t, r.index)), e = l(E, r), e ? (B += e[1], a += p(e[0], n(r[0])))
                                                               : a += n(r[0]), t =
                    E.lR.lastIndex, r =
                    E.lR.exec(k);
            }
        ...
        function m(e, n) {
            ...
            var t = o(n, E);
            if (t) {
                return t.skip ? k += n : (t.eB && (k += n), b(), t.rB || t.eB || (k = n)), v(t,
                                                                                             n), t.rB
                                                                                                 ? 0
                                                                                                 : n.length;
            }
            ...
            if (c(n, E)) {
                throw new Error('Illegal lexeme "' + n + '" for mode "' + (E.cN
                                                                           || "<unnamed>")
                                + '"');
            }
    ...
    function d(e) {
        ...
        a(s) || (I.useBR ? (n =
            ...
            e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n")) : n = e, l =
            n.textContent, r = s ? f(s, l, !0) : g(l), t = u(n), t.length && (o =
            document.createElementNS("http://www.w3.org/1999/xhtml", "div"), o.innerHTML =
            r.value, r.value = c(t, u(o), l)), r.value = p(r.value), e.innerHTML =
            r.value, e.className = h(e.className, s, r.language), e.result =
    ...
    return e.highlight = f, e.highlightAuto = g, e.fixMarkup = p, e.highlightBlock =
        d, e.configure = b, e.initHighlighting = v, e.initHighlightingOnLoad =
        m, e.registerLanguage = N, e.listLanguages = R, e.getLanguage = w, e.inherit = o, e.IR =
...
hljs.registerLanguage("php", function (e) {
    var c = {b: "\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*"}, i = {cN: "meta", b: /<\?(php)?|\?>/}, t = {
        cN: "string",
        c: [e.BE, i],
        v: [{b: 'b"', e: '"'}, {b: "b'", e: "'"}, e.inherit(e.ASM, {i: null}),
    ...
    return {
        ...
        c: [e.HCM, e.C("//", "$", {c: [i]}),
            ...
            }, {bK: "namespace", e: ";", i: /[\.']/, c: [e.UTM]}, {bK: "use", e: ";", c: [e.UTM]},
            {b: "=>"}, t, a]
    }
});
    ...
    return {
        ...
        c: n.concat([i, {
            ...
            c: [{b: a, rB: !0, c: [t.TM], r: 0},
                {cN: "params", b: /\(/, e: /\)/, k: c, r: 0, c: [t.CLCM, t.CBCM, r, s, e]}, t.CLCM,
                                                                                            t.CBCM,
                                                                                            i]
        }, {
            cN: "class",
...
hljs.registerLanguage("cs", function (e) {
    var i = {
        ...
        o = e.inherit(s, {i: /\n/, c: [{b: "{{"}, {b: "}}"}, {b: '""'}, c]});
    a.c = [s, n, t, e.ASM, e.QSM, e.CNM, e.CBCM], c.c =
        [o, n, r, e.ASM, e.QSM, e.CNM, e.inherit(e.CBCM, {i: /\n/})];
...
hljs.registerLanguage("ruby", function (e) {
    var b = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",
        ...
        s = [e.C("#", "$", {c: [c]}), e.C("^\\=begin", "^\\=end", {c: [c], r: 10}),
...
hljs.registerLanguage("javascript", function (e) {
    ...
    return {
        aliases: ["js", "jsx"],
        k: t,
        c: [{cN: "meta", r: 10, b: /^\s*['"]use (strict|asm)['"]/}, {cN: "meta", b: /^#!/, e: /$/},
    ...
    return {
        ...
        c: [e.HCM, {cN: "section", b: "</?", e: ">"}, {
            ...
            starts: {
                ...
                c: [{cN: "meta", b: "\\s\\[", e: "\\]$"},
                    {cN: "variable", b: "[\\$%]\\{", e: "\\}", c: ["self", r]}, r, e.QSM]
            }
        }],
        i: /\S/
    }
...
hljs.registerLanguage("xml", function (s) {
    ...
    return {
        ...
        cI: !0,
        c: [{cN: "meta", b: "<!DOCTYPE", e: ">", r: 10, c: [{b: "\\[", e: "\\]"}]},
...
hljs.registerLanguage("kotlin", function (e) {
    var t = {
            ...
            built_in: "Byte Short Char Int Long Boolean Float Double Void Unit Nothing String Any Note ClickListener Activity View OnClickListener",
            literal: "true false null"
        }, r = {
            cN: "keyword",
            b: /\b(break|continue|return|this)\b/,
            starts: {c: [{cN: "symbol", b: /@\w+/}]}
        }, i = {cN: "symbol", b: e.UIR + "@"}, n = {cN: "subst", b: "\\${", e: "}", c: [e.ASM, e.CNM]},
    ...
    return {
        k: t,
        c: [e.C("/\\*\\*", "\\*/", {r: 0, c: [{cN: "doctag", b: "@[A-Za-z]+"}]}), e.CLCM, e.CBCM, r,
            i, s, o, {
                cN: "function",
                bK: "fun",
                e: "[(]|$",
...
hljs.registerLanguage("groovy", function (e) {
    return {
        k: {
            literal: "true false null",
            keyword: "plugin byte short char int long boolean float double void def as in assert trait super this abstract static volatile transient public private protected synchronized final class interface enum if else for while switch case break default continue throw throws try catch finally implements extends new import package return instanceof"
        },
        c: [e.C("/\\*\\*", "\\*/", {r: 0, c: [{b: /\w+@/, r: 0}, {cN: "doctag", b: "@[A-Za-z]+"}]}),
            ...
            {cN: "meta", b: "^#!/usr/bin/env", e: "$", i: "\n"}, e.BNM, {
                cN: "class",
                bK: "plugin class interface trait enum",
                e: "{",
                i: ":",
                c: [{bK: "extends implements"}, e.UTM]
